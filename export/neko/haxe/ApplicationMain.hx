...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TheLostTallywartRemake", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("TheLostTallywartRemake", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TheLostTallywartRemake";
		app.meta["name"] = "TheLostTallywartRemake";
		...
		#elseif air
		app.window.title = "TheLostTallywartRemake";
		#else
